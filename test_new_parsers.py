...
def test_bank_card_extracts_holder_name():
    ...
    lines = [
        ...
        OCRLine(text="XIANG RI KUI", left=50, top=150, right=220, bottom=175, score=0.98),
    ]
...
def test_bank_card_rejects_non_luhn_bin_false_positive():
    print("\n--- Testing Bank Card Non-Luhn False Positive Rejection ---")
    lines = [
        OCRLine(text="8888 8888 885L 5229", left=50, top=80, right=400, bottom=110, score=0.99),
    ]
    result = OCRParser().parse(Layout(lines), document_type="bank_card")
